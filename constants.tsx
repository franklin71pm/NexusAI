...
export const NAVIGATION_ITEMS = [
  {
    view: View.Dashboard,
    label: 'Dashboard',
    subtitle: 'Una vista general de tu actividad reciente.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>,
  },
  {
    view: View.Documents,
    label: 'Documentos',
    subtitle: 'Gestiona y analiza tus documentos entrantes y salientes.',
  ...
  },
  {
    view: View.Tasks,
    label: 'Tareas',
    subtitle: 'Organiza y gestiona tus tareas pendientes.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 9h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>,
  },
  {
    // Fix: Changed View.Calendar to View.Events to match App.tsx switch case
    view: View.Events,
    label: 'Eventos',
    subtitle: 'Administra tus eventos y citas importantes.',
  ...
  },
  {
    view: View.Files,
    label: 'Carpetas',
    subtitle: 'Organiza tus carpetas y archivos.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" /></svg>,
  },
  {
    view: View.Reports,
    label: 'Informes',
    subtitle: 'Genera informes y visualiza datos.',
  ...
  },
  {
    view: View.Trash,
    label: 'Papelera',
    subtitle: 'Revisa y recupera elementos eliminados.',
  ...
  },
  {
    view: View.Settings,
    label: 'Configuración',
    subtitle: 'Personaliza la apariencia y el comportamiento de la aplicación.',
